...
// Prepare data
var data = climateData[climateDataIdx];
...
try {
  for (var _iterator = data.temp[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
try {
  for (var _iterator2 = data.prec[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    var _month = _step2.value;

    data.prec_long.push(_month.raw_data);
  } // DRAW !!!
} catch (err) {
